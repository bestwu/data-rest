...
public class VersionSupportRestTemplate extends TestRestTemplate {
	...
	public <T> ResponseEntity<T> delete(String url, MediaType mediaType, Object... uriVariables) throws RestClientException {
	...
	public <T> ResponseEntity<T> delete(String url, MediaType mediaType, Map<String, ?> urlVariables) throws RestClientException {
		ResponseExtractor<ResponseEntity<T>> responseExtractor = responseEntityExtractor(null);
